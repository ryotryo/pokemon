...
const diagramRenderers = {
  ...
  "hp-parity": () => <DiagramFrame title="端数を残すか、半分以下へ入れるか" caption="奇数・偶数そのものではなく、使いたい技や持ち物の条件から最大HPを決めます。"><div className="grid gap-4 sm:grid-cols-2"><div><p className="mb-2 text-xs font-black text-slate-700">みがわりを繰り返す</p><MiniCard label="HP200" value="3回まで" note="4回目は使えない"/><Arrow label="比べる"/><MiniCard label="HP201" value="4回使える" note="最後にHP1"/></div><div><p className="mb-2 text-xs font-black text-slate-700">はらだいこ＋オボンのみ</p><MiniCard label="HP200" value="残り100" note="半分以下・発動"/><Arrow label="比べる"/><MiniCard label="HP201" value="残り101" note="半分より多い・未発動"/></div></div></DiagramFrame>,
