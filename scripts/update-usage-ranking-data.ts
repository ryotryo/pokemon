...
function rowsByCategory(rows: UsageBattleRow[], category: string): UsageBattleRow[] {
  return rows.filter((row) => row.category === category).sort((a, b) => a.rank - b.rank).slice(0, 10);
}
