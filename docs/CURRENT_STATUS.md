...
2026-09-21（「ポケモン対戦の基礎」全45記事のコース番号付与後に更新）

## Current focus

初心者向けの学習コンテンツ「ポケモン対戦の基礎」は、導入15記事と第2弾30記事の計45記事を、第1〜45回の連続したコースとして公開しています。ポケモン個別の理解は「このポケモンってどんなポケモン？」、ルールや用語の理解は「ポケモン対戦の基礎」へ分けて運用します。
