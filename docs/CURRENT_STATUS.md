...
2026-09-20（「ポケモン対戦の基礎」第2弾30記事公開後に更新）

## Current focus

初心者向けの学習コンテンツ「ポケモン対戦の基礎」は、完全初心者コース15記事と第2弾30記事の計45記事を公開しています。ポケモン個別の理解は「このポケモンってどんなポケモン？」、ルールや用語の理解は「ポケモン対戦の基礎」へ分けて運用します。

## Current state

- パーティー相性チェッカー、すばやさランキング、使用率ランキング、ダメージ早見表、技からポケモン検索、pokemon-intro、役割一覧、ポケモン対戦の基礎を公開中。
- 「ポケモン対戦の基礎」は8カテゴリの共通定義と構造化記事データを使用し、計45記事を公開。完全初心者コース15記事のreading order 1〜15は維持し、第2弾30記事はカテゴリと関連記事から読む構成。
